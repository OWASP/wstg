...
# Combine the files
pdftk build/cover-$1.pdf build/wstg-doc-$1.pdf cat output build/wstg-com-$1.pdf
...
pdftk build/wstg-com-$1.pdf dump_data_utf8 output build/pdf_data
...
pdftk build/wstg-com-$1.pdf update_info_utf8 build/pdf_data output build/wstg-$1.pdf