...
9. Is the credential chosen for the user by the application, such as a social security number or a birthdate? Is the credential that's utilized in liueu of a standard password easily obtainable, predictable, or able to be brute forced?
