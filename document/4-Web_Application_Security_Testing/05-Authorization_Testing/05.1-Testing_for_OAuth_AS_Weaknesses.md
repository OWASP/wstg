...
Test every request that contains one of the anti CSRF parameters used by OAuth according to the test described in the [CSRF](../06-Session_Management_Testing/05-Testing_for_Cross_Site_Request_Forgery.md) testcases.
...
grant_type=refresh_token&refresh_token=eyJhbGciOiJIUz[...]&client_id=example-client
