...
2. Investigate if the sensitive data can be leaked using JavaScript:
  - Using global variables (see[leak sensitive data via global variable](## Example - Leak Sensitive Data via Global Function Parameters))
  - Overwriting global functions and parameters (see "leak sensitive function parameters" example)
