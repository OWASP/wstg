...
An LDAP search filter is constructed in Polish notation, also known as [Polish notation prefix notation](https://en.wikipedia.org/wiki/Polish_notation_prefix_notation).
...
- [Bruce Greenblatt: LDAP Overview](https://www.directory-applications.com/ldap3_files/frame.htm)
- [IBM paper: Understanding LDAP](https://www.redbooks.ibm.com/redbooks/SG244986.html)
