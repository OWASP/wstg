...
- [Access Through Access - Brett Moore](http://packetstormsecurity.com/files/65967/Access-Through-Access.pdf.html)
- [Access SQL Injection - Brett Moore](http://seclists.org/pen-test/2003/May/74)
- [MS Access: Functions](http://www.techonthenet.com/access/functions/index_alpha.php)
- [Microsoft Access - Wikipedia](http://en.wikipedia.org/wiki/Microsoft_Access)
