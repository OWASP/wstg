...
![common template expressions](../images/SSTI_XVWA.jpeg)
...
Based on the information from the previous step in this step the tester has to identify which template engine is used using the following decision tree:
![common template expressions](../images/SSTI_identify.jpeg)

Both this and the previous step can be automated using [Tplmap](https://github.com/epinna/tplmap) or the [Backslash Powered Scanner Burp Suite extension](https://github.com/PortSwigger/backslash-powered-scanner).
...
2. [Server-Side Template Injection](https://portswigger.net/blog/server-side-template-injection?source=post_page---------------------------)
...
6. [Divine Selorm Tsa: Exploiting server side template injection with tplmap](https://www.owasp.org/images/7/7e/Owasp_SSTI_final.pdf)
