...
[Testing for Bypassing Session Management Schema (WSTG-SESS-001)](../4.7_Session_Management_Testing/4.4.1_Test_Role_Definitions_WSTG-IDENT-001.md)

[Testing for Exposed Session Variables (WSTG-SESS-004)](../4.7_Session_Management_Testing/4.4.4_Testing_for_Account_Enumeration_and_Guessable_User_Account_WSTG-IDENT-004.md)
