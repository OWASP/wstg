...
- [Session Manager for Chrome](https://chrome.google.com/webstore/detail/session-manager/mghenlmbmjcpehccoangkdpagbcbkdpc)
...
- [MySessions for Firefox](https://addons.mozilla.org/en-US/firefox/addon/my-sessions/)

MySessions is a simple session manager. You can quickly save your current browser state and reload it whenever necessary.
This is not a replacement for Michael Kraft's "Session Manager", but it allows you to import saved sessions from the "Session Manager".

- [Cookie Swap for Chrome](https://chrome.google.com/webstore/detail/dffhipnliikkblkhpjapbecpmoilcama)
