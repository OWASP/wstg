...
3. if the password change or reset process is vulnerable to [CSRF](../4.7_Session_Management_Testing/4.7.5_Testing_for_CSRF_OTG-SESS-005.md).
...
- What information is required to reset the password?
  ...
  On the other hand, if secret questions are used, the next step is to assess their strength. This specific test is discussed in detail in the [Testing for Weak security question/answer](4.5.8_Testing_for_Weak_Security_Question_Answer_OTG-AUTHN-008.md) paragraph of this guide.
...
- Is the old password requested to complete the change?
  ...
  See also [Testing for Weak password policy](4.5.7_Testing_for_Weak_Password_Policy_OTG-AUTHN-007.md) paragraph of this guide.
