...
Cache details are also available via DevTools in most modern browsers (Firefox, Chrome, Edge). With Firefox it is also possible to use the URL `about:cache` to check cache details.
