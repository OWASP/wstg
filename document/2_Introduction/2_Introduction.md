...
Many things need to be tested during the development life cycle of a web application, but what does testing actually mean? The Merriam-Webster Dictionary defines "test" as:
...
Threat modeling tools such as threat trees and attack libraries can be useful to derive the negative test scenarios. A threat tree will assume a root attack (e.g., attacker might be able to read other users' messages) and identify different exploits of security controls (e.g., data validation fails because of an SQL injection vulnerability) and necessary countermeasures (e.g., implement data validation and parametrized queries) that could be validated to be effective in mitigating such attacks.
...
To derive security requirements from use and misuse cases, [[20]] it is important to define the functional scenarios and the negative scenarios and put these in graphical form. The following example is a step-by-step methodology for the case of deriving security requirements for authentication.
...
The target for the security tests is the complete system that is vulnerable to attack, including both the whole source code and the executable. During this phase, it is possible for security testers to determine whether vulnerabilities can be exploited and expose the application to real risks. These include common web application vulnerabilities, as well as security issues that have been identified earlier in the SDLC with other activities such as threat modeling, source code analysis, and secure code reviews.
...
It is important to note that unknown security issues are not tested. The fact that a security test is clear of issues does not mean that the software or application is good. Some studies [[22]] have demonstrated that, at best, tools can only find 45% of overall vulnerabilities.
...
- The remediation of the vulnerability (i.e., the countermeasure), and
- The severity rating of the vulnerability (e.g., High, Medium, Low and/or CVSS score).
...
[2]:https://www.sans.org/reading_room/whitepapers/auditing/55.php
[3]:https://www.nist.gov/director/planning/upload/report02-3.pdf
[4]:https://www.cl.cam.ac.uk/~rja14/econsec.html
[5]:https://www.owasp.org/index.php/OWASP_AppSec_NYC_2004
[6]:https://www.schneier.com/crypto-gram-0009.html
[7]:https://www.symantec.com/security_response/publications/threatreport.jsp
[8]:https://business.ftc.gov/privacy-and-security/gramm-leach-bliley-act
[9]:https://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=200120020SB1386
[10]:https://ec.europa.eu/justice/policies/privacy/docs/95-46-ce/dir1995-46_part1_en.pdf
[11]:https://csrc.nist.gov/publications/nistpubs/800-30-rev1/sp800_30_r1.pdf
[12]:https://www.cert.org/octave/
[13]:https://www.archive.ece.cmu.edu/~ganger/712.fall02/papers/p761-thompson.pdf
[14]:https://www.drdobbs.com/security/beyond-the-badness-ometer/189500001
[15]:https://www.ffiec.gov/pdf/authentication_guidance.pdf
[16]:https://www.pcisecuritystandards.org/security_standards/index.php
[17]:https://msdn.microsoft.com/en-us/library/ms978518.aspx#tmwacheatsheet_webappsecurityframe
[18]:https://en.wikipedia.org/wiki/STRIDE_(security)
[19]:https://folk.uio.no/nik/2001/21-sindre.pdf
[20]:https://www.cyberpartnership.org/SDLCFULL.pdf
[21]:https://cwe.mitre.org/documents/being-explicit/BlackHatDC_BeingExplicit_Slides.ppt
[22]:https://www.blackhat.com/presentations/bh-usa-06/bh-us-06-Morana-R3.0.pdf
